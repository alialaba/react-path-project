...
const Starter = (props) => {
    return (
        <div className="container wrap-center">
            <svg className="blob-1" width="158" height="141" viewBox="0 0 158 141" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="starter__content">
                ...
                <Button styles="btn-primary" text="Start quiz" onClick={props.onStart} />
            </div>
            <svg className="blob-2" width="148" height="118" viewBox="0 0 148 118" fill="none" xmlns="http://www.w3.org/2000/svg">
